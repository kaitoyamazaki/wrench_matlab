...
test_times1 = cross(test1, test2);
test_times2 = cross(test2, test3);
test_times3 = cross(test3, test1);

syms x y z;

plane1 = test_times1(1) * x + test_times1(2) * y + test_times1(3) * z;
plane2 = test_times2(1) * x + test_times2(2) * y + test_times2(3) * z;
plane3 = test_times3(1) * x + test_times3(2) * y + test_times3(3) * z;
